...
def filter_by_course(student_list: list, course: str) -> list:
    ...
    """
    filtered_course = filter(lambda student: course in student.courses, student_list)
    return list(filtered_course)
...
def succeeding_students(student_list: list) -> list:
    ...
    """
    suc_students = filter(lambda student: not is_failing(student), student_list)
    return list(suc_students)
...
def failing_students(student_list: list) -> list:
    ...
    """
    suc_students = filter(lambda student: is_failing(student), student_list)
    return list(suc_students)
...
def sort_by_best_grade(student_list: list) -> list:
    ...
    """
    sorted_students = sorted(succeeding_students(student_list), key=lambda student: student.grade, reverse=True)
...
def sort_by_worst_grade(student_list: list) -> list:
    ...
    """
    sorted_students = sorted(succeeding_students(student_list), key=lambda student: student.grade)
    return list(sorted_students)
