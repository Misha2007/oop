...
class Zoo:
    ...
    def can_add_animal(self, animal: Animal) -> bool:
        ...
        for animal_in_zoo in self.animals:
            if animal_in_zoo.name == animal.name and animal_in_zoo.species == animal.species:
                return False
    ...
    def get_animals_by_age(self):
        ...
        """
        sorted_animals = sorted(self.animals, key=lambda animal: animal.age)
    ...
    def get_animals_sorted_alphabetically(self):
        ...
        """
        sorted_animals = sorted(self.animals, key=lambda animal: animal.name)
        return sorted_animals
